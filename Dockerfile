...
# Next.js coleta informações completamente anônimas sobre uso geral.
# Saiba mais aqui: https://nextjs.org/telemetry
# Descomente a linha seguinte caso você queira desabilitar o telemetria durante o build.
...
# Descomente a linha seguinte caso você queira desabilitar o telemetria durante o runtime.
# ENV NEXT_TELEMETRY_DISABLED 1
